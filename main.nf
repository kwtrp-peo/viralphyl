...
workflow  {
    ...
    // Start the pipeline by checking the --protocol parameter
    switch (params.protocol.toLowerCase()) {
        ...
        case 'amplicon':        // Run the amplicon-based pipeline
            AMPLICON_BASED()
            break 
        default:                // Handle invalid --protocol values
            log.error "ERROR: Invalid --protocol '${params.protocol}'. Choose either 'amplicon' or 'metagenomics'."
