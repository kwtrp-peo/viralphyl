...
<body>
    <div class="dashboard-container">
        ...
        <div class="footer">
            Generated by <strong><a href="https://github.com/kwtrp-peo/viralphyl" target="_blank" rel="noopener noreferrer">kwtrp-peo/viraphyl</a> v0.7.0</strong> on {generation_date} | 
    ...
    <script>
        ...
        function updateClassificationChart(sample) {{
            ...
            const data = [{{
                values: [classifiedPct, unclassifiedPct],
        ...
        function updateReadsChart(sample) {{
            ...
            // Create data array and sort by count in descending order
            const data = [
                {{
                    name: 'Total Reads',
            ...
            const chartData = [{{
                ...
                type: 'bar',
                marker: {{
                    color: ['var(--secondary)', 'var(--primary)', 'var(--danger)']
                }}
            }}];
        ...
        function createComparisonChart() {{
            ...
            const unclassified = sampleData.map(s => {{
                if (s.Unclassified_Pct) return s.Unclassified_Pct;
                return 100 - classified[samples.indexOf(s.Sample)];
            }});
